...
const InfoSection = () => {
  return (
    <Wrapper className="w-[90%] m-auto text-justify">
      <SectionHeading className="font-medium  mb-4">
        AFFORDABLE ELEGANCE
      </SectionHeading>
      <ParaText className="text-[#575757] mb-8">
        To achieve this, it would be necessary to have uniform grammar,
        pronunciation and more common words. If several languages coalesce, the
        grammar of the resulting language is more simple and regular than that
        of the individual languages. The new common language will be more
        simple. It will be as simple as Occidental; in fact, it will be
      ...
      <SectionHeading className="font-medium  mb-4">
        TIPS FOR LUXE DECOR ON A BUDGET
      </SectionHeading>
      <ParaText className="text-[#575757] mb-8">
        To achieve this, it would be necessary to have uniform grammar,
        pronunciation and more common words. If several languages coalesce, the
      ...
      <ParaText className="text-[#575757] mb-8">
        ...
        translators. The languages only differ in their grammar, their
        pronunciation and their most common words. Everyone realizes why a new
        common language would be desirable: one could refuse to pay expensive
        translators. To achieve this, it would be necessary to have uniform
        grammar, pronunciation and more common words. To achieve this.
      </ParaText>
      <SectionHeading className="py-8 font-medium  text-center">
        You may also like
      </SectionHeading>
