  ...
  return (
    <Wrapper className="flex flex-wrap-reverse md:flex-nowrap gap-6 md:gap-8 w-full lg:w-[90%] mx-auto items-center">
      ...
      <div className="basis-full md:basis-1/2 space-y-4 md:space-y-6">
        <LargeHeading className="leading-snug font-bold">
          Home Construction starts from <span className="text-[#2A27E8]">RS 1100/-</span>
        </LargeHeading>
        <SectionSubHeading>
          Seamless Home Interior & Home Construction: Start To Finish, Hassle-Free. Effortless Home Interior & Home
          Construction Solutions: From Concept to Completion.
        </SectionSubHeading>
      ...
      <div className="basis-full md:basis-1/2">
        <Image src={ConstructionImg} alt="Construction Process" className="mx-auto" />
      </div>
    </Wrapper>
  );
}
